...
void MD5Init_ESP32 (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void MD5Update_ESP32 (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void MD5Final_ESP32 (unsigned char digest[16], MD5_CTX *context)
{
  ...
  MD5Update_ESP32 (context, PADDING, padLen);

  /* Append length (before padding) */
  MD5Update_ESP32 (context, bits, 8);
...
void MD5(unsigned char strInputString[], unsigned char md5Digest[], unsigned int len){
	...
	MD5Update_ESP32(&ctx, strInputString, len);
	MD5Final_ESP32(md5Digest, &ctx);
}
