...
Blockly.JavaScript['wait'] = function(block) {
  var number_seconds = block.getFieldValue('seconds');
  // TODO: Assemble JavaScript into code variable.
  var code = 'sleep for ' + number_seconds + 's\n';
  return code;
};
...
Blockly.Dart['motor'] = function(block) {
  ...
  var dropdown_motorspeed = block.getFieldValue('motorSpeed');
  // TODO: Assemble JavaScript into code variable.
  var code = 'setEngine(' + dropdown_motornumber + ',' + dropdown_motordirection + ',' + dropdown_motorspeed + ');' + '\n';
  return code;
};
...
Blockly.JavaScript['motor'] = function(block) {
  ...
  if (dropdown_motordirection == 0)
	  ...
	  var code = 'set Engine on Port ' + dropdown_motornumber + ' to ' + 'rigth-hand rotation' + ' and speed ' + dropdown_motorspeed + '\n';
  // TODO: Assemble JavaScript into code variable.
  return code;
};
